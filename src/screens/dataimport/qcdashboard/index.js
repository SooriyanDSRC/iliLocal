...
export default function QcDashboard(props) {
   ...
   const saveQcDashboardData = (validationFlag, flag = null) => {
      ...
      let data = {};
      data[formDataInput.iliFieldDetails] = JSON.parse(formData.excelTemplateDto).iliFieldDetails;
      ...
      data[formDataInput.reportDate] = _.head(JSON.parse(formData.excelTemplateDto).iliInspectionDetails).reportDate;
      data[formDataInput.importDate] = _.head(JSON.parse(formData.excelTemplateDto).iliInspectionDetails).importDate;
      data[formDataInput.inspectionGuid] = savedInspectionGuid;
      data[formDataInput.iliInspectionDetails] = JSON.parse(formData.excelTemplateDto).iliInspectionDetails;
